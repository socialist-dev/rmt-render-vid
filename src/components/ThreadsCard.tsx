...
// SVG Heart (Like) - 34px, màu #cccccc
const HeartIcon = () => (
...
export const ThreadsCard: React.FC<any> = ({
    ...
    return (
        <div style={{
            ...
            {/* Thanh nối Thread (#333638) cho bài Reply */}
            {isReply && (
                <div style={{
                    position: 'absolute',
                    top: '-37px',
            ...
            {/* Header: Avatar tròn, Username, Follow / Timestamp, Logo */}
