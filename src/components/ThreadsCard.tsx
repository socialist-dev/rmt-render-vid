...
export const ThreadsCard: React.FC<any> = ({
    ...
    return (
        <div style={{
            ...
            display: 'flex',
            flexDirection: 'row' // BỐ CỤC 2 CỘT: Cột trái chứa Avatar + Thanh nối, Cột phải chứa nội dung
        }}>
            {/* CỘT TRÁI: Avatar & Thanh nối dọc Thread Line (#333638) */}
            <div style={{
                display: 'flex',
                ...
                {/* THANH DỌC NỐI THREAD CHUẨN (#333638) CHỈ HIỆN KHI LÀ BÀI REPLY */}
                {isReply && (
                    <div style={{
                        width: '3px',
                        flex: 1,
            ...
            <div style={{ flex: 1, display: 'flex', flexDirection: 'column' }}>
                {/* Header: Handle + Follow (Chỉ bài chính mới có Follow, bài Reply chỉ có Handle) */}
                ...
                <div style={{ 
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
                        <HeartIcon />
                        {likes !== '0' && (
                            <span style={{ fontSize: '26px', fontWeight: '600', color: '#cccccc', lineHeight: 1 }}>
                                {likes}
                            </span>
                        )}
                    </div>
