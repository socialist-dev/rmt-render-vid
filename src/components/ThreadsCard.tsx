...
// 1. Threads Logo
const ThreadsLogo = () => (
    <svg height="28px" viewBox="0 0 192 192" width="28px" xmlns="http://www.w3.org/2000/svg" style={{ color: '#fff' }}>
...
// 2. SVG Heart (Like)
const HeartIcon = () => (
    <svg aria-label="Like" role="img" viewBox="-0.5 0 25 24" width="24px" height="24px" style={{ color: '#f3f5f7' }}>
...
// 3. SVG Reply
const ReplyIcon = () => (
    <svg aria-label="Reply" role="img" viewBox="0 0 24 24" width="24px" height="24px" style={{ color: '#f3f5f7' }}>
...
// 4. SVG Repost
const RepostIcon = () => (
    <svg aria-label="Repost" role="img" viewBox="0 0 24 24" width="24px" height="24px" style={{ color: '#f3f5f7' }}>
...
// 5. SVG Share / Send
const ShareIcon = () => (
    <svg aria-label="Share" role="img" viewBox="0 0 24 24" width="24px" height="24px" style={{ color: '#f3f5f7' }}>
...
export const ThreadsCard: React.FC<any> = ({
    ...
    return (
        <div style={{
            background: '#101010', // Dark theme chuẩn Threads
            ...
            {/* Header: Avatar, Handle, Timestamp, Threads Logo */}
            <div style={{ display: 'flex', alignItems: 'center', marginBottom: '18px' }}>
                ...
                <div style={{ flex: 1, display: 'flex', alignItems: 'center', gap: '8px' }}>
                    <span style={{ fontWeight: '700', fontSize: '26px', color: '#f3f5f7' }}>
                        {handle}
                    </span>
                    <span style={{ color: '#777', fontSize: '22px', fontWeight: '400' }}>
                        · {timestamp}
                    </span>
                </div>
                <ThreadsLogo />
            ...
            <div style={{ 
                ...
                lineHeight: 1.45, 
                color: '#f3f5f7', 
                marginBottom: mediaUrl ? '20px' : '24px', 
                textAlign: 'left', 
                fontWeight: '400',
            ...
            {/* Action Icons Bar (Heart, Reply, Repost, Share) */}
            <div style={{ 
                display: 'flex', 
                alignItems: 'center', 
                gap: '28px', 
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                    <HeartIcon />
                    {likes !== '0' && <span style={{ fontWeight: '500', color: '#777' }}>{likes}</span>}
                </div>

                {/* Reply Button */}
                <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                    <ReplyIcon />
                    {replies !== '0' && <span style={{ fontWeight: '500', color: '#777' }}>{replies}</span>}
                </div>

                {/* Repost Button */}
                <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                    <RepostIcon />
                    {reposts !== '0' && <span style={{ fontWeight: '500', color: '#777' }}>{reposts}</span>}
                </div>
