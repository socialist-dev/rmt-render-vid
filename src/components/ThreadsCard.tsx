...
// 2. SVG Heart (Like) - 34px, màu #cccccc
const HeartIcon = () => (
...
export const ThreadsCard: React.FC<any> = ({
    ...
    return (
        <div style={{
            ...
            {/* Header: Avatar, Username, Follow / Timestamp, Logo */}
            <div style={{ display: 'flex', alignItems: 'center', marginBottom: '20px' }}>
                ...
                <div style={{ flex: 1, display: 'flex', alignItems: 'center', gap: '8px' }}>
                    ...
                    {!isReply ? (
                        ...
                        timestamp && (
                            <>
                                <span style={{ color: '#777777', fontSize: '24px' }}>·</span>
            ...
            {/* Action Icons Bar: Đồng bộ icon và chỉ số màu #cccccc */}
            <div style={{ 
                display: 'flex', 
                alignItems: 'center', 
                gap: '36px', 
